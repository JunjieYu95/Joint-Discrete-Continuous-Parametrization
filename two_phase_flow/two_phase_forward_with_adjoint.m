...
function [mismatch, ad_gradient] = two_phase_forward_with_adjoint(Norm_perm,MRST_folder)
...
mismatch = sum(vertcat(mismatch{:}));

%% obtain the adjoint gradient
% setup parameters that adjoint gradient solver needs
...
% the matchObservedOW function can be found in modules/optimization/objectives
...
% /modules/ad-core/simulators/computeSensitivitiesAdjointAD.m

% compute the gradient
ad_gradient = raw_sens.permx;
end
